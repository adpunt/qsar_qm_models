...
ARMS = {
    ...
    'C Grouped lam=3':     lambda t, r: grouped(ytr, t, 3.0, 0.2, sc_tr, r),
    'D Contam p=0.05':     lambda t, r: contaminated(ytr, t, 0.05, 3.0, r),
    'D Contam p=0.10':     lambda t, r: contaminated(ytr, t, 0.10, 3.0, r),
}
...
out = '/private/tmp/claude-501/-Users-apunt-repos-qsar-qm-models/28450b4e-4a9e-4197-993c-548e1dd48b09/scratchpad/pilot_results.csv'
