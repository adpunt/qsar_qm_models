...
# Line plots:
python3 process_and_train.py -t homo_lumo_gap -m rf xgboost svm gauche dnn -r ecfp4 sns smiles randomized_smiles -n 15000 -f ../results/linePlot.csv  --sigma 0.0 0.25 0.5 0.75 1.0 1.25 1.5 1.75 2.0 -b 10 -p /data/stat-cadd/scat9264/qsar_qm_models/results/tuning.json

python3 process_and_train.py -t homo_lumo_gap -m gin gcn -r graph -n 15000 -f ../results/linePlot.csv  --sigma 0.0 0.25 0.5 0.75 1.0 1.25 1.5 1.75 2.0 -b 10 -p /data/stat-cadd/scat9264/qsar_qm_models/results/tuning.json

# Extra line plots:
python3 process_and_train.py -t homo_lumo_gap -m rf xgboost svm gauche dnn mtl residual_mlp factorization_mlp mlp rnn gru -r ecfp4 sns smiles randomized_smiles -n 15000 -f ../results/linePlotExtra.csv  --sigma 0.0 0.25 0.5 0.75 1.0 1.25 1.5 1.75 2.0 -b 5 -p /data/stat-cadd/scat9264/qsar_qm_models/results/tuning.json
...
python3 process_and_train.py -t homo_lumo_gap -m rf xgboost gauche dnn -r ecfp4 sns smiles -n 15000 -f scaffold.csv  --sigma 0.0 0.25 0.5 0.75 1.0 1.25 1.5 1.75 2.0 -b 5 --split scaffold -p /data/stat-cadd/scat9264/qsar_qm_models/results/tuning.json

# Mu and alpha
python3 process_and_train.py -t mu -m gauche -r ecfp4 sns smiles -n 20000 -f ../results/tuningMu.csv -b 5 --sigma 0.0 0.25 0.5 0.75 1.0 1.25 1.5 1.75 2.0 -b 5 -p /data/stat-cadd/scat9264/qsar_qm_models/results/tuningMu.json

python3 process_and_train.py -t alpha -m svm gauche -r ecfp4 sns smiles -n 20000 -f ../results/tuningAlpha.csv -b 5 --sigma 0.0 0.25 0.5 0.75 1.0 1.25 1.5 1.75 2.0 -b 5 -p /data/stat-cadd/scat9264/qsar_qm_models/results/tuningAlpha.json
