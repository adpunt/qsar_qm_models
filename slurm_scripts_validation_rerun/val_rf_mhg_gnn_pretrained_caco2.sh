#!/bin/bash
#SBATCH --job-name=val_RF_mhg_gnn_pretrained_caco2
...
python "$QSAR_DIR/scripts/check_environment.py" --validation-models RF || {
    echo "ERROR: this interpreter cannot build RF. See above."
    exit 2
}
...
echo "Done: RF x MHG-GNN-pretrained x caco2"
