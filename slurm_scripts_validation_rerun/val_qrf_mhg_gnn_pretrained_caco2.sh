#!/bin/bash
#SBATCH --job-name=val_QRF_mhg_gnn_pretrained_caco2
...
python "$QSAR_DIR/scripts/check_environment.py" --validation-models QRF || {
...
echo "Done: QRF x MHG-GNN-pretrained x caco2"
