#!/bin/bash
# ============================================================================
# Hyperparameter sweep: lgb on 6 representation(s).
#
...
# representation (ecfp4, 143s per fit) x 13 fits x 3.0
...
#   sbatch --account=stat-cadd --partition=medium --array=0-5%6 tune_lgb.sh
#
...
# ============================================================================
#SBATCH --job-name=tune_lgb
#SBATCH --output=tune_lgb_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python scripts/check_environment.py --models lgb || {
    echo "ERROR: this interpreter cannot build model 'lgb'."
    exit 2
}
