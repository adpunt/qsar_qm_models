#!/bin/bash
# ============================================================================
# QM9 re-run — stage 1 — model: xgboost
# xgboost
# ============================================================================
...
#   sbatch --account=<acct> --partition=medium --array=0-17%5 qm9_s1_xgboost.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s1_xgboost.sh
# ============================================================================
#SBATCH --job-name=qm91_xgboost
#SBATCH --output=qm91_xgboost_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python check_environment.py --models xgboost || {
    echo "ERROR: this interpreter cannot build model 'xgboost'. See the output above."
    exit 2
}
...
OUT="../results/anova_${cond}_${rep}_xgboost.csv"

echo "=== task $i: model=xgboost condition=$cond rep=$rep"
