...
#   sbatch --account=<acct> --partition=medium --array=0-17%5 qm9_s0_qrf.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s0_qrf.sh
# ============================================================================
#SBATCH --job-name=qm90_qrf
#SBATCH --output=qm90_qrf_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
