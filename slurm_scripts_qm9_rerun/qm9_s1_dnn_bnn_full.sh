#!/bin/bash
# ============================================================================
# QM9 re-run — stage 1 — model: dnn_bnn_full
# BNN-alpha
# ============================================================================
...
#   sbatch --account=<acct> --partition=medium --array=0-17%5 qm9_s1_dnn_bnn_full.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s1_dnn_bnn_full.sh
# ============================================================================
#SBATCH --job-name=qm91_dnn_bnn_full
#SBATCH --output=qm91_dnn_bnn_full_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
