#!/bin/bash
# ============================================================================
# QM9 re-run — stage 0 — model: mlp_bnn_full_variational
...
#   sbatch --account=<acct> --partition=medium --array=0-17%5 qm9_s0_mlp_bnn_full_variational.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s0_mlp_bnn_full_variational.sh
# ============================================================================
#SBATCH --job-name=qm90_mlp_bnn_full_variational
#SBATCH --output=qm90_mlp_bnn_full_variational_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
