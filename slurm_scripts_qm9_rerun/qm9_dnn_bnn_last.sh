#!/bin/bash
# ============================================================================
# QM9 re-run — model: dnn_bnn_last
# last-layer BNN (no significant gain over base)
# ============================================================================
...
#   sbatch --account=<acct> --partition=medium --array=0-29%5 qm9_dnn_bnn_last.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_dnn_bnn_last.sh
# ============================================================================
#SBATCH --job-name=qm9_dnn_bnn_last
#SBATCH --output=qm9_dnn_bnn_last_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUT="../results/anova_${tag}_${rep}_dnn_bnn_last.csv"

echo "=== task $i: model=dnn_bnn_last strategy=$strat rep=$rep"
echo "=== out: $OUT"
echo "=== started: $(date)"
