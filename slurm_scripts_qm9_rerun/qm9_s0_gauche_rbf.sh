#!/bin/bash
# ============================================================================
# QM9 re-run — stage 0 — model: gauche_rbf
...
#   sbatch --account=<acct> --partition=medium --array=0-17%5 qm9_s0_gauche_rbf.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s0_gauche_rbf.sh
# ============================================================================
#SBATCH --job-name=qm90_gauche_rbf
#SBATCH --output=qm90_gauche_rbf_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
