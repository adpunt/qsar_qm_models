#!/bin/bash
# ============================================================================
# QM9 re-run — stage 0 — model: ngboost
...
#   sbatch --account=<acct> --partition=medium --array=0-17%5 qm9_s0_ngboost.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s0_ngboost.sh
# ============================================================================
#SBATCH --job-name=qm90_ngboost
#SBATCH --output=qm90_ngboost_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
