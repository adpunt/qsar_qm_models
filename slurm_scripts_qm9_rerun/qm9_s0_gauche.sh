#!/bin/bash
# ============================================================================
# QM9 re-run — stage 0 — model: gauche
...
#   sbatch --account=<acct> --partition=medium --array=0-5%5 qm9_s0_gauche.sh
#
# Resubmit only failed indices:
#   sbatch --account=<acct> --partition=medium --array=3,17 qm9_s0_gauche.sh
# ============================================================================
#SBATCH --job-name=qm90_gauche
#SBATCH --output=qm90_gauche_%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
