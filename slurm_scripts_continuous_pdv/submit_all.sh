...
echo ""
echo "=== continuous_pdv UNCERTAINTY experiments ==="
...
echo ""
echo "Output CSVs:"
echo "  ANOVA:       ../results/anova_{strategy}_continuous_pdv_{model}.csv"
echo "  Uncertainty: ../results/uncertainty_{strategy}_continuous_pdv_{model}.csv"
echo ""
