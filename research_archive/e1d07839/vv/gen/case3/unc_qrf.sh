...
#   3 datasets x 4 reps x 6 strategies = 48 tasks
#
...
#
#   sbatch --account=<acct> --partition=medium --array=0-47%6 \
#          unc_qrf.sh
#
...
STRATS=(legacy outlier quantile valprop)
...
echo "=== task $SLURM_ARRAY_TASK_ID: model=QRF dataset=$ds rep=$rep strategy=$st"
echo "=== out: $OUT"
echo "=== started: $(date)"
