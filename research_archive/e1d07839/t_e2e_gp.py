...
M.run_dataset('TINY', smiles, labels, out, model_filter=['GP'], rep_filter=['PDV'],
              sigma_levels=[0.0,0.6], unc_strategies='all', oof_folds=5, strategies=['quantile'], gp_reps=['PDV'])
